                ...
                <div class="row">
                    <div class="col-xs-12">
                        <form action="Login" id="authentication" method="post" class="login_validator">
                            ...
                            <div class="form-group">
                                <input type="submit" value="Sign In" class="btn btn-primary btn-block" id="#userLoginBtn"/>
                            </div>
...
$(document).ready(function(){
	 ...
	 $.ajax({
		 ...
		 data: '&email='+j_emailid+'&password='+j_password,
         cache: false,
	     success = fuction(data){
        	 
        	 var json = JSON.parse(data);
        	 
        	 if(json.details.Login == "N"){
        		 
        		 $("#errorName").html(json.details.errorMessage);
