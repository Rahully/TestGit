...
<%
	...
	JSONObject object = JSONObject.fromObject(request.getAttribute("slideDetails"));
    ...
    <aside class="right-side">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li>
                    <a href="slide_list.html"> Slides</a>
                </li>
                <li class="active">
                     Slides
                </li>
                ...
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="livicon" data-name="user-add" data-size="18" data-c="#fff" data-hc="#fff"
                                   data-loop="true"></i> Add New Slide
                            </h3>
                        ...
                        <div class="panel-body">
                            <!-- errors -->
                            <!--main content-->
                            <form action="EditSlideDetails?id=<%=  object.getString("id") %>"  id="edit_slide_form" method="post" class="form-horizontal">
                                <input type="hidden" name="_token" />
									<div id="pager_wizard">
										<ul>
											<li><a href="#tab1" data-toggle="tab">Slide Profile</a>
											</li>
											...
											<div class="tab-pane" id="tab1">
												...
												<div class="form-group">
													<label for="slideshow_name" class="col-sm-3 control-label">Slideshow
														Name * </label>
													<div class="col-sm-6">
														<select id="slideshow_name" name="slideshow_name" value="<%=  object.getString("slideshow_name") %>"
															placeholder="slideshow_name" class="form-control">
															<option value="">select slideshow</option>
															


															<option value="">slideshow1 </option>
												...
												<div class="form-group">
													<label for="start_date" class="  col-sm-3 control-label">Start
														Date *</label>
													<div class="col-sm-6">
														<input id="start_date" type="text" name="start_date" value="<%=  object.getString("startdate") %>"
												...
												<div class="form-group">
													<label for="end_date" class="  col-sm-3 control-label">End
														Date *</label>
													<div class="col-sm-6">
														<input id="end_date" name="end_date" value="<%=  object.getString("expirydate") %>"
												...
												<div class="form-group">
													<label class="control-label col-sm-3"> image_path </label>
													<div class="col-sm-6">

														<input name="add_file" value="<%=  object.getString("image_path") %>"
