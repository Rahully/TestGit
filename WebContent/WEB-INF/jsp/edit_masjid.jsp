...
<%
	...
	JSONObject object = JSONObject.fromObject(request.getAttribute("masjid_Details"));
                ...
                <div class="col-md-12">
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="livicon" data-name="user-add" data-size="18" data-c="#fff" data-hc="#fff"
                                   data-loop="true"></i> Edit Masjid Details
                            </h3>
                        ...
                        <div class="panel-body">
                            <!-- errors -->
                            <!--main content-->
                            <form action="EditMasjidDetails?mid=<%=  object.getString("id") %>" id="adduser_form" method="post"  class="form-horizontal">
                           <input type="hidden" name="_token"/>
                                <div id="pager_wizard">
                                    <ul>
                                        <li>
                                            <a href="#tab1" data-toggle="tab">Masjid Profile</a>
                                        </li>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane" id="tab1">
                                            <h2 class="hidden">&nbsp;</h2>       <!-- CSRF Token -->
											<input id="masjid_id" name="masjid_id" type="hidden" value="" />
                                            <div class="form-group">
                                                <label for="masjid_name"  class="col-sm-3 control-label">Masjid Name *
                                                </label>
                                                <div class="col-sm-6">
                                    
                                                    <input id="masjid_name" name="masjid_name" type="text" value=" <%=  object.getString("masjid_name") %>" 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input id="street" name="street" type="text"
                                                           value="<%=  object.getString("street") %>" placeholder="Last Name" class="form-control required"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="city" class="  col-sm-3 control-label">City *</label>
                                                <div class="col-sm-6">
                                                    <input id="city" name="city" placeholder="City" type="text" value="<%=  object.getString("city") %>"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input id="state" name="state" type="text"
                                                           value="<%=  object.getString("state") %>" placeholder="State" class="form-control required"/>
                                                </div>
                                            </div>
										</div>
                                        ...
                                        <ul class="pager wizard">
                                            ...
                                            <li>
                                                <input type="submit" name="save" class="btn btn-primary pull-rights" value="Update">
                                            </li>
                                        </ul>
