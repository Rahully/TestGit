...
<%
	...
	JSONArray object = JSONArray.fromObject(request.getAttribute("userDetails"));
%>
				...
				<div class="row">
					<div class="col-md-12">
									...
									<table class="table table-bordered" id="table">
										...
										<tbody>
											...
											<tr>
												...
												<td><%=SelectedObj.getString("Name")%></td>
												<td><%=SelectedObj.getString("email_id")%></td>
												<td><%=SelectedObj.getString("contact_number")%></td>
												<td><%=SelectedObj.getString("isSuperAdmin")%></td>
												<td><%=SelectedObj.getString("isActive")%></td>

												<td><a
													href="EditUser?uid=<%=SelectedObj.getString("user_id")%>"><i
														class="fa fa-fw ti-pencil text-primary actions_icon"
														title="Edit User"></i></a> <a
													href="DeleteUser?uid=<%=SelectedObj.getString("user_id")%>"><i
														class="fa fa-fw ti-close text-danger actions_icon"
														title="Delete User"></i> </a><a href="user_profile.html"><i
						...
						<div class="modal fade" id="delete" tabindex="-1" role="dialog"
							aria-labelledby="Heading" aria-hidden="true">
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-footer ">
										<a href="deleted_users.html" class="btn btn-danger"> <span
