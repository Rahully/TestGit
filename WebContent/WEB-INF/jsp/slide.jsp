                ...
                <div class="col-md-12">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            <!-- errors -->
                            <!--main content-->
                            <form id="edit_slide_form" method="POST" enctype="multipart/form-data" class="form-horizontal">
                                <!-- CSRF Token -->
                                <input type="hidden" name="_token"/>
                                <div id="pager_wizard">
                                    <ul>
                                        <li>
                                            <a href="#tab1" data-toggle="tab">Slide Profile</a>
                                        </li>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane" id="tab1">
                                            ...
                                            <div class="form-group">
                                                <label for="masjid_name" class="col-sm-3 control-label">id *
                                                </label>
                                                <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                <label for="start_date" class="  col-sm-3 control-label">Slideshow_id *</label>
                                                <div class="col-sm-6">
                                                    <input id="Slideshow_id" name="Slideshow_id" placeholder="Slideshow_id"
