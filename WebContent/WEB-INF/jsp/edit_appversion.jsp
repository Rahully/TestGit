...
<%
	...
	JSONObject object1 = JSONObject.fromObject(request.getAttribute("appVersionDetails"));
%>
	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<aside class="right-side">
			...
			<section class="content-header">
				<h1>Edit App Version Details</h1>
						...
						<div class="panel">
							<div class="panel-heading">
								<h3 class="panel-title">
									<i class="livicon" data-name="user-add" data-size="18"
										data-c="#fff" data-hc="#fff" data-loop="true"></i> Edit
									Appversion Details
								</h3>
							...
							<div class="panel-body">
								...
								<form id="adduser_form"
									action="EditVersionDetails?aid=<%=object1.getString("app_ver_id")%>"
									...
									<div id="pager_wizard">
										<ul>
											<li><a href="#tab1" data-toggle="tab">Edit Details</a></li>
												...
												<div class="form-group">
													...
													<div class="col-sm-6">
														<input id="version" name="version" type="text"
															value="<%=object1.getString("version")%>"
															placeholder="Version" class="form-control required" />
													</div>
												</div>
												<div class="form-group">
													<label for="last_name" class="col-sm-3 control-label">Version
														Date * </label>
													<div class="col-sm-6">
														<input id="version_date" name="version_date" type="date"
															value="<%=object1.getString("version_date")%>"
												...
												<div class="form-group">
													...
													<div class="col-sm-6">
														<input id="description" name="description" type="text"
															value="<%=object1.getString("description")%>"
