...
<%
	...
	JSONArray object1 = JSONArray.fromObject(request.getAttribute("slideshowDetails"));
	JSONArray object2 = JSONArray.fromObject(request.getAttribute("appVersionDetails"));
	JSONObject object3 = JSONObject.fromObject(request.getAttribute("deviceCode"));
%>
					...
					<div class="col-md-12">
						<div class="panel">
							<div class="panel-heading">
								<h3 class="panel-title">
									<i class="livicon" data-name="user-add" data-size="18"
										data-c="#fff" data-hc="#fff" data-loop="true"></i> Add Device
								</h3>
							...
							<div class="panel-body">
								<!-- errors -->
								<!--main content-->
								<form action="AddDevice" id="edit_slide_form" method="post"
									class="form-horizontal">

									<div class="form-group">
										<label for="masjid_name" class="col-sm-3 control-label">Device
											Name * </label>
										<div class="col-sm-6">
											<input id="device_name" name="device_name" type="text"
												placeholder="device Name " class="form-control required" />
										</div>
									</div>
									...
									<div class="form-group">
										<label for="slideshow" class="col-sm-3 control-label">Slideshow
											* </label>
										<div class="col-sm-6">
											<select name="slideshow" class="form-control">
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input id="device_code" name="device_code" type="text"
												value="<%= object3.getString("device_code") %>" placeholder="Device Code" class="form-control "
												readonly />
										</div>
									</div>
									<div class="form-group">
									...
									<div class="modal-dialog">
										...
										<div class="modal-content">
											...
											<div class="modal-body">
												<p>Device Created Successfully.</p>
											</div>
