						...
						<div class="panel">
							<div class="panel-heading">
								<h4 class="panel-title">
									<i class="ti-user"></i> Masjid List <a href="AddMasjid"
									...
									<table class="table table-bordered" id="table">
										...
										<tbody>
											...
											<tr>
												...
												<td><%=SelectedObj.getString("street")%></td>
												<td><%=SelectedObj.getString("city")%></td>
												<td><%=SelectedObj.getString("state")%></td>

												<td><a
													href="EditMasjid?mid=<%=SelectedObj.getString("id")%>"> <i
														class="fa fa-fw ti-pencil text-primary actions_icon"
														title="Edit User"></i>
												</a> <a href="DeleteMasjid?mid=<%=SelectedObj.getString("id")%>"><i
