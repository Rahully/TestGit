...
<%
	...
	JSONArray object = JSONArray.fromObject(request.getAttribute("deviceDetails"));
%>
<!DOCTYPE html>
<html>
<base
						...
						<div class="panel">
							<div class="panel-heading">
								<h4 class="panel-title">
									<i class="ti-user"></i> Device List <a href="AddDevice"
								...
								<div class="table-responsive">
									<table class="table table-bordered" id="table">
										...
										<tbody>
											...
											<tr>
												<td><%=SelectedObj.getString("device_name")%></td>
												<td><%=SelectedObj.getString("masjid_name")%></td>
												<td><%=SelectedObj.getString("slideshow_name")%></td>
												<td><%=SelectedObj.getString("device_code")%></td>
												<td><a href="EditDevice?did=<%=SelectedObj.getString("device_id")%>"> <i
														class="fa fa-fw ti-pencil text-primary actions_icon"
														title="Edit User"></i>
												</a> <a href="DeleteDevice?did=<%=SelectedObj.getString("device_id")%>"><i
