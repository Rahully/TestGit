...
<body class="skin-default">
					...
					<div class="col-md-12">
						<div class="panel">
							...
							<div class="panel-body">
								<!-- errors -->
								<!--main content-->
								<form action="AddnewSlide" id="edit_slide_form" method="post" enctype="multipart/form-data"
											...
											<div class="tab-pane" id="tab1">
												...
												<div class="form-group">
													<label for="slideshow_name" class="col-sm-3 control-label">Slideshow
														Name * </label>
													<div class="col-sm-6">
														<select id="slideshow_name" name="slideshow_name"
	...
	<script src="js/custom_js/datepicker.js"></script>
