...
<%
	...
	JSONObject object1 = JSONObject.fromObject(request.getAttribute("dasboardDetails"));
%>
...
<meta charset="UTF-8">
<title>Masjid | Administration</title>
<meta
...
<link href="vendors/nvd3/css/nv.d3.min.css" rel="stylesheet"
	type="text/css">
...
<link href="css/custom_css/dashboard1.css" rel="stylesheet"
	type="text/css" />
...
<%@ include file="sidemenu.jsp" %>
		<aside class="right-side">
			...
			<section class="content">
						...
						<div class="flip">
							...
							<div class="widget-bg-color-icon card-box back">
								<div class="text-center">
									...
									<hr>
									<p> <a href="ViewMasjidList">Check summary</a></p>
								</div>
								<div class="clearfix"></div>
							</div>
						</div>
					...
					<div class="col-sm-6 col-md-6 col-lg-3">
						<div class="flip">
							<div class="widget-bg-color-icon card-box front">
								...
								<div class="text-right">
									<h3>
										<b id="widget_count3"><%=object1.getString("slides")%></b>
									</h3>
									<p>Slides</p>
								</div>
								<div class="clearfix"></div>
						...
						<div class="flip">
							...
							<div class="widget-bg-color-icon card-box back">
								<div class="text-center">
									...
									<hr>
									<p> <a href="ViewAppVersionList">Check summary</a></p>
								</div>
								<div class="clearfix"></div>
							</div>
						</div>
						...
						<div class="flip">
							...
							<div class="widget-bg-color-icon card-box back">
								<div class="text-center">
									...
									<hr>
									<p> <a href="ViewUsers">Check summary</a></p>
								</div>
								<div class="clearfix"></div>
							</div>
						</div>
				...
				<div class="col-md-12">
					<img src="img/masjid-kristal.png" class="img img-responsive">
				</div>
				<!--rightside bar -->
				<div id="right">
					<div id="right-slim">
	...
	<script type="text/javascript"
		src="js/custom_js/sparkline/jquery.flot.spline.js"></script>
	<!-- flip --->
	<script type="text/javascript"
		src="vendors/flip/js/jquery.flip.min.js"></script>
	<script type="text/javascript"
		src="vendors/lcswitch/js/lc_switch.min.js"></script>
	<!--flot chart-->
	<script type="text/javascript"
		src="vendors/flotchart/js/jquery.flot.js"></script>
	<script type="text/javascript"
		src="vendors/flotchart/js/jquery.flot.resize.js"></script>
	<script type="text/javascript"
		src="vendors/flotchart/js/jquery.flot.stack.js"></script>
	<script type="text/javascript"
		src="vendors/flotspline/js/jquery.flot.spline.min.js"></script>
	<script type="text/javascript"
		src="vendors/flot.tooltip/js/jquery.flot.tooltip.js"></script>
	<!--swiper-->
	...
	<script type="text/javascript"
		src="vendors/advanced_newsTicker/js/newsTicker.js"></script>
