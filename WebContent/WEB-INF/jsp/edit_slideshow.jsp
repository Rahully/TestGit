...
JSONObject object1 = JSONObject.fromObject(request.getAttribute("slideDetails"));
%>
	...
	<div class="wrapper row-offcanvas row-offcanvas-left">
		...
		<aside class="right-side">
			...
			<section class="content-header">
				<h1>Update SlideShow Details</h1>
					...
					<div class="col-md-12">
						<div class="panel">
							<div class="panel-heading">
								<h3 class="panel-title">
									<i class="livicon" data-name="user-add" data-size="18"
										data-c="#fff" data-hc="#fff" data-loop="true"></i> Update details
								</h3>
							...
							<div class="panel-body">
								<!-- errors -->
								<!--main content-->
								<form action="EditSlideShowDetails?sid=<%=  object1.getString("slide_id") %>"  id="edit_slide_form" method="post"
											...
											<div class="tab-pane" id="tab1">
												...
												<div class="form-group">
													<label for="masjid_name" class="col-sm-3 control-label">Masjid
														Name * </label>
													<div class="col-sm-9">
														<input id="masjid_name" name="masjid" type="text" value="<%=object1.getString("masjid_name")%>"
												...
												<div class="form-group">
													...
													<div class="col-sm-6">
														<div class="col-sm-6">
															<input id="slideshow_name" value="<%=object1.getString("slideshow_name")%>" name="slideshow_name"
										...
										<div class="modal-dialog">
											...
											<div class="modal-content">
												...
												<div class="modal-body">
													<p>Slide Details Edited Successfully.</p>
												</div>
